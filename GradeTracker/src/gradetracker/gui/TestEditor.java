...
public class TestEditor extends JFrame {
	...
	public void createTheGUIControls() {
		...
		cBTestType.setModel(new DefaultComboBoxModel(new String[] {"Test", "Exam", "Assignment", "IA", "Homework", "Other"}));
		...
		btnSave.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				AppData.students.get(AppData.studentNumber).subjects.get(AppData.subjectNumber).tests.get(AppData.testNumber).setTopicName(tFTestName.getText());
				AppData.students.get(AppData.studentNumber).subjects.get(AppData.subjectNumber).tests.get(AppData.testNumber).setType((String) cBTestType.getSelectedItem());
				AppData.students.get(AppData.studentNumber).subjects.get(AppData.subjectNumber).tests.get(AppData.testNumber).setDate(tFTestDate.getText());
				AppData.students.get(AppData.studentNumber).subjects.get(AppData.subjectNumber).tests.get(AppData.testNumber).setLevel(Integer.parseInt((String) cBTestLevel.getSelectedItem()));
				AppData.students.get(AppData.studentNumber).subjects.get(AppData.subjectNumber).tests.get(AppData.testNumber).setScore(tFTestScore.getText());
				AppData.students.get(AppData.studentNumber).subjects.get(AppData.subjectNumber).tests.get(AppData.testNumber).setOutOf(tFTestOutOf.getText());
				AppData.students.get(AppData.studentNumber).subjects.get(AppData.subjectNumber).tests.get(AppData.testNumber).setWeight(Integer.parseInt(tFTestWeight.getText()));
				AppData.students.get(AppData.studentNumber).subjects.get(AppData.subjectNumber).tests.get(AppData.testNumber).setReflection(tFReflection.getText());
				AppState.saveToFile();
				SubjectEditor se = new SubjectEditor();
				se.setVisible(true);
				close();
		...
		tFTestName.setText(
				AppData.students.get(AppData.studentNumber).subjects.get(AppData.subjectNumber).tests.get(AppData.testNumber).getTopicName());
		cBTestType.setSelectedItem(
				AppData.students.get(AppData.studentNumber).subjects.get(AppData.subjectNumber).tests.get(AppData.testNumber).getType());
		tFTestDate.setText(
				AppData.students.get(AppData.studentNumber).subjects.get(AppData.subjectNumber).tests.get(AppData.testNumber).getDate());
		cBTestLevel.setSelectedItem(
				AppData.students.get(AppData.studentNumber).subjects.get(AppData.subjectNumber).tests.get(AppData.testNumber).getLevel() + "");
		tFTestScore.setText(
				String.valueOf(AppData.students.get(AppData.studentNumber).subjects.get(AppData.subjectNumber).tests.get(AppData.testNumber).getScore()));
		tFTestOutOf.setText(
				String.valueOf(AppData.students.get(AppData.studentNumber).subjects.get(AppData.subjectNumber).tests.get(AppData.testNumber).getOutOf()));
		tFTestWeight.setText(
				String.valueOf(AppData.students.get(AppData.studentNumber).subjects.get(AppData.subjectNumber).tests.get(AppData.testNumber).getWeight()));
		tFReflection.setText(
				AppData.students.get(AppData.studentNumber).subjects.get(AppData.subjectNumber).tests.get(AppData.testNumber).getReflection());
